        ...
        <div className="grid max-w-screen-xl grid-cols-1 gap-10 pt-10 mx-auto mt-5 border-t border-gray-100 dark:border-trueGray-700 lg:grid-cols-5">
          <div className="lg:col-span-2">
            ...
            <div className="max-w-md mt-4 text-gray-500 dark:text-gray-400">
              Utilizamos las tecnologías y frameworks más innovadores para construir
              sitios responsivos, rápidos y seguros. Además, nos enfocamos tanto en
              la experiencia de usuario como en aspectos técnicos para asegurar un
              producto completo y de calidad.
            </div>
          </div>
